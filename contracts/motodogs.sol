...
contract MotoDogs is ERC721AEnumerable, ERC2981, Ownable {
    using Strings for uint256;

    uint256 private maxSalePlusOne = 10001;

    uint256 public usdPrice = 6800000000 ether; //USD price has 8 decimals (5$ = 500000000)
    ...
    constructor() ERC721AEnumerable("MotoDogs", "MDCC") {
        baseURI = "ipfs://QmPrdZiZ39vUoebRhW4NYE4HupEqBmCw7fjVsrJ7aVRJgF/";
    ...
    {
        require(quantity < allowancePlusOne, "Exceeds allowance");
        _safeMint(to, quantity);
    }
